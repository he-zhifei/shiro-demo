package com.zhifei.plugin.exception.advice;
 ...
 */
@RestControllerAdvice(/*basePackages = {"com.zhifei.controller"}, */
        annotations = {GlobalException.class})
public class GlobalControllerExceptionAdvice extends com.zhifei.plugin.exception.advice.AbstractControllerExceptionAdvice {

    // 方便其他系统（或配置指定异常对应的异常码）使用，异常与返回结果描述信息对应
    static {
        // shiro认证
        builder.put(IncorrectCredentialsException.class, RCode.INCORRECT_CREDENTIAL);
        // shiro鉴权
