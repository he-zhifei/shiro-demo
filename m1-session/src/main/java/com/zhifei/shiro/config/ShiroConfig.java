...
import com.zhifei.shiro.realm.CustomRealm;
import com.zhifei.shiro.session.CustomSessionManager;
...
//        bean.setLoginUrl("/sysUser/unAuth");
        ...
        // authc过滤器默认不支持记住我功能，user过滤器支持，安全性较高的接口（支付）建议用authc
